...
<script>
    const setupOfflineWidget = () => {
        if (!window.Alpine) return;
        
        // Prevent double registering if script runs multiple times
        if (Alpine.data && !window.__denbOfflineWidgetRegistered) {
            window.__denbOfflineWidgetRegistered = true;
    ...
    if (window.Alpine) {
        ...
        document.addEventListener('alpine:init', setupOfflineWidget);
    }
</script>
</x-filament-widgets::widget>
